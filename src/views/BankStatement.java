...
public class BankStatement extends javax.swing.JFrame {
    ...
    public BankStatement() {
        ...
        transactions = jdbc.FetchAccountTransactions(activeAccount.getAccNumber());
        jdbc = null;
        statementTable.setModel(DbUtils.resultSetToTableModel(transactions));
        jdbc = new JDBC();
        availableBalance = jdbc.getAccountBalance(activeAccount.getAccNumber());
        balanceLabel.setText("Available Balance : P " + String.format("%.2f",availableBalance));
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("BANK STATEMENT");
        ...
        balanceLabel.setFont(new java.awt.Font("DialogInput", 1, 21)); // NOI18N
        balanceLabel.setText("Available Balance : P 400.00");
